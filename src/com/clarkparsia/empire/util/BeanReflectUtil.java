...
public class BeanReflectUtil {
	...
	/**
	 * Return whether or not the accessor is marked with a {@link FetchType#EAGER} annotation.  If there is no
	 ...
	 * @return true if the accessor is marked with {@link FetchType#EAGER}, false otherwise.
	 */
	public static boolean isFetchTypeEAGER(Object theAccessor) {
		...
		return aFetchType.equals(FetchType.EAGER);
	}
